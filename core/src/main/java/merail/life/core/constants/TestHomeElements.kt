...
object TestHomeElements {
    ...
    const val COUNTRY_RUSSIA = "Россия"
    const val COUNTRY_TURKEY = "Турция"

    const val PLACE_MOSCOW = "Москва"
    const val PLACE_KARELIA = "Карелия"
    const val PLACE_CAPPADOCIA = "Каппадокия"
    const val PLACE_MURMANSK = "Мурманская область"
